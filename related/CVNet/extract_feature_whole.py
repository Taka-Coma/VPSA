...
import test.test_loader_1m_whole as loader
...
def main():
		...
		os.makedirs('data/features/revisitop1m', exist_ok=True)
		...
		for data_dir in glob('data/datasets/revisitop1m/jpg/*'):
			...
			np.save(f'data/features/revisitop1m_whole/{dir_name}_cvnet_vp_glob.npy', X)
