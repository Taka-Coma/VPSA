...
### for cvnet
Q = np.load(f'data/data/features/query/{test_dataset}_cvnet_vp_glob.npy')
X = np.load(f'data/data/features/gallery/{test_dataset}_cvnet_vp_glob.npy')
#Q = np.load(f'data/data/features/query/{test_dataset}_cvnet_w_whole_glob.npy')
#X = np.load(f'data/data/features/gallery/{test_dataset}_cvnet_w_whole_glob.npy')
...
sim = np.dot(X, Q.T)
sims = [sim]
sims += [np.dot(np.load(path), Q.T) for path in glob('data/data/features/revisitop1m/*')]
#sims += [np.dot(np.load(path), Q.T) for path in glob('data/data/features/revisitop1m_whole/*')]
sim = np.vstack(sims)
